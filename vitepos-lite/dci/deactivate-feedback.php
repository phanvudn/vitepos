...
if ( ! function_exists( 'vtp_dci_deactivate_feedback' ) ) {
	/**
	 * The dci deactivate feedback is generated by appsbd
	 *
	 * @param mixed $data It is data param.
	 */
	function vtp_dci_deactivate_feedback( $data ) {
		...
		?>
		<div class="apbd-dci-feedback-wrapper" id="<?php echo esc_attr( $plugin_deactivate_id ); ?>" style="display:none;">
			<div class="apbd-dci-feedback-card">
				<h2><?php esc_html_e( 'Give feedback', 'vitepos-lite' ); ?></h2>
				<p><?php esc_html_e( 'Goodbyes are never easy. If you have a moment, please share your feedback on how we can improve.', 'vitepos-lite' ); ?>
				</p>
				<form method="get" class="apbd-dci-notice-data">
					...
					<input type="hidden" name="version" value="<?php echo esc_html( $version ); ?>">
					<div class="apbd-dci-feedback-tabs">
						<div class="apbd-dci-checkbox-group">
							<div class="apbd-dci-checkbox">
								<label class="apbd-dci-checkbox-wrapper">
									<input type="checkbox" class="apbd-dci-checkbox-input" name="switching-domain" />
									<span class="apbd-dci-checkbox-tile">
										<span class="apbd-dci-checkbox-icon">
										...
										<span
												class="apbd-dci-checkbox-label"><?php esc_html_e( 'Switching Domain', 'vitepos-lite' ); ?></span>
									</span>
								</label>
							</div>
							<div class="apbd-dci-checkbox">
								<label class="apbd-dci-checkbox-wrapper">
									<input type="checkbox" class="apbd-dci-checkbox-input" name="couldnt-understand" />
									<span class="apbd-dci-checkbox-tile">
										<span class="apbd-dci-checkbox-icon">
										...
										<span
												class="apbd-dci-checkbox-label"><?php esc_html_e( 'Couldn\'t understand', 'vitepos-lite' ); ?></span>
									</span>
								</label>
							</div>
							<div class="apbd-dci-checkbox">
								<label class="apbd-dci-checkbox-wrapper">
									<input type="checkbox" class="apbd-dci-checkbox-input" name="found-a-better-plugin" />
									<span class="apbd-dci-checkbox-tile">
										<span class="apbd-dci-checkbox-icon">
		...
		c12.322-12.327,12.322-32.307-0.005-44.634L1579.829,1125.662z" />
										...
										<span
												class="apbd-dci-checkbox-label"><?php esc_html_e( 'Found a better plugin', 'vitepos-lite' ); ?></span>
									</span>
								</label>
							</div>
							<div class="apbd-dci-checkbox">
								<label class="apbd-dci-checkbox-wrapper">
									<input type="checkbox" class="apbd-dci-checkbox-input" name="missing-a-specific-feature" />
									<span class="apbd-dci-checkbox-tile">
										<span class="apbd-dci-checkbox-icon">
	...
	C499.5,480.7,531.3,438.3,499.5,385.4z M298.4,438.3h-84.7v-84.7h84.7V438.3z M298.4,311.3h-84.7V120.7h84.7V311.3z" />
										...
										<span
												class="apbd-dci-checkbox-label"><?php esc_html_e( 'Missing a specific feature', 'vitepos-lite' ); ?></span>
									</span>
								</label>
							</div>
							<div class="apbd-dci-checkbox">
								<label class="apbd-dci-checkbox-wrapper">
									<input type="checkbox" class="apbd-dci-checkbox-input" name="not-working" />
									<span class="apbd-dci-checkbox-tile">
										<span class="apbd-dci-checkbox-icon">
		...
		C442.303,271.102,426.367,287.057,406.663,287.057z" />
										...
										<span
												class="apbd-dci-checkbox-label"><?php esc_html_e( 'Not working', 'vitepos-lite' ); ?></span>
									</span>
								</label>
							</div>
							<div class="apbd-dci-checkbox">
								<label class="apbd-dci-checkbox-wrapper">
									<input type="checkbox" class="apbd-dci-checkbox-input" name="others" />
									<span class="apbd-dci-checkbox-tile">
										<span class="apbd-dci-checkbox-icon">
											<svg width="192" height="192" fill="currentColor" viewBox="0 0 32 32" id="icon"
												...
												<rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;"
														class="apbd-dci-icon-others-1" width="32" height="32" />
											</svg>
										</span>
										<span
												class="apbd-dci-checkbox-label"><?php esc_html_e( 'Others', 'vitepos-lite' ); ?></span>
									</span>
								</label>
							</div>
						</div>
					</div>
					<div class="apbd-dci-feedback-comments">
						<label>
							<?php esc_html_e( 'What is the main reason for deactivating?', 'vitepos-lite' ); ?>
						</label>
						<textarea name="user-message" rows="4"></textarea>
					</div>
					<div class="apbd-dci-feedback-actions">
						<a class="skip-button" href="<?php echo esc_url( $deactivate_url ); ?>">
							<?php esc_html_e( 'Skip & Deactivate', 'vitepos-lite' ); ?>
						</a>
						<div>
							<a class="button" href="<?php echo esc_url( $plugin_page_url ); ?>">
								<?php esc_html_e( 'Cancel', 'vitepos-lite' ); ?>
							</a>
							<button name="dci_status_sub_and_dea" value="skip" type="button"
									class="apbd-dci-feedback-submit-btn button button-secondary"
									data-deactivate-url="<?php echo esc_url( $deactivate_url ); ?>">
								<?php esc_html_e( 'Submit & Deactivate', 'vitepos-lite' ); ?>
							</button>
						</div>
					</div>
				</form>
