...
if ( ! function_exists( 'vitepos_move_uploaded_file' ) ) {
	/**
	 * The vitepos move uploaded file is generated by appsbd
	 *
	 * @param mixed $file It is file param.
	 * @param mixed $destination It is destination param.
	 *
	 * @return bool
	 */
...
if ( ! function_exists( 'vitepos_read_file_with_wp_filesystem' ) ) {
	/**
	 * The vitepos read file with wp filesystem is generated by appsbd
	 *
	 * @param mixed $file_path It is file_path param.
	 *
	 * @return false
	 */
