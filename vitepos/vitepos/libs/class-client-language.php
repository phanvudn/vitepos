...
if ( ! class_exists( __NAMESPACE__ . '\Client_Language' ) ) {
	...
	class Client_Language {
		...
		public static function get_admin_languages( &$kernel_object ) {
			...
			$language['Capture on order complete (Recommended)']                        = $kernel_object->__( 'Capture on order complete (Recommended)' );
			...
			$language['Tax Calculation Method (Only for exclusive tax)'] = $kernel_object->__( 'Tax Calculation Method (Only for exclusive tax)' );
			...
			$language['On Cart/Invoice']                         = $kernel_object->__( 'On Cart/Invoice' );
			$language['Show']                         = $kernel_object->__( 'Show' );
			$language['On Printed Receipt/Invoice']                         = $kernel_object->__( 'On Printed Receipt/Invoice' );
			$language['Custom']                         = $kernel_object->__( 'Custom' );
			
			$language['Swipe']                         = $kernel_object->__( 'Swipe' );
			$language['Stripe']                         = $kernel_object->__( 'Stripe' );
			$language['Is Required Card Last 4 Digit']                         = $kernel_object->__( 'Is Required Card Last 4 Digit' );
			$language['Swipe Settings']                         = $kernel_object->__( 'Swipe Settings' );
			$language['Position']                         = $kernel_object->__( 'Position' );
			$language['Into the buttons']                         = $kernel_object->__( 'Into the buttons' );
			$language['Above the buttons']                         = $kernel_object->__( 'Above the buttons' );
			$language['Below the buttons']                         = $kernel_object->__( 'Below the buttons' );
			...
			$language['Add extra input field if require']                         = $kernel_object->__( 'Add extra input field if require' );
			$language['Not saved yet']                         = $kernel_object->__( 'Not saved yet' );
			$language['Custom Methods']                         = $kernel_object->__( 'Custom Methods' );
			$language['Add Input']                         = $kernel_object->__( 'Add Input' );
			$language['Icons']                         = $kernel_object->__( 'Icons' );
			$language['Method Name']                         = $kernel_object->__( 'Method Name' );
			$language['Is Show In Receipt']                         = $kernel_object->__( 'Is Show In Receipt' );
			$language['Are you sure to remove ?']                         = $kernel_object->__( 'Are you sure to remove ?' );
			$language['Input Name']                         = $kernel_object->__( 'Input Name' );
			$language['Resetting role']                         = $kernel_object->__( 'Resetting role' );
			...
			$language[' Point of sale (POS) plugin for wordpress and Woocommerce']                         = $kernel_object->__( ' Point of sale (POS) plugin for wordpress and Woocommerce' );
			$language['This plugin adds a beautiful mini cart feature to your WooCommerce website, allowing easy customization to match your preferences.']                         = $kernel_object->__( 'This plugin adds a beautiful mini cart feature to your WooCommerce website, allowing easy customization to match your preferences.' );
			$language['Vite Coupon is a comprehensive coupon management system designed to simplify the creation, distribution, and tracking of discount coupons for online businesses.']                         = $kernel_object->__( 'Vite Coupon is a comprehensive coupon management system designed to simplify the creation, distribution, and tracking of discount coupons for online businesses.' );
			$language['Get Pro']                         = $kernel_object->__( 'Get Pro' );
			$language['Product Videos']                         = $kernel_object->__( 'Product Videos' );
			$language['Product Details']                         = $kernel_object->__( 'Product Details' );
			$language['See Details']                         = $kernel_object->__( 'See Details' );
			$language['Activate Pro']                         = $kernel_object->__( 'Activate Pro' );
			...
			$language['Custom payment methode support in pro version only.']                         = $kernel_object->__( 'Custom payment methode support in pro version only.' );
			$language['This roles user can see payment notes on order details']                         = $kernel_object->__( 'This roles user can see payment notes on order details' );
			$language['shortcut message']                         = $kernel_object->__( 'shortcut message' );
			$language['Order']                         = $kernel_object->__( 'Order' );
			$language['deny reason']                         = $kernel_object->__( 'deny reason' );
			$language['Text']                         = $kernel_object->__( 'Text' );

			
			$language['Stripe Terminal Settings']                         = $kernel_object->__( 'Stripe Terminal Settings' );
			$language['Map With Readers']                         = $kernel_object->__( 'Map With Readers' );
			$language['Add New']                         = $kernel_object->__( 'Add New' );
			$language['Recommend barcode logo height 256px.']                         = $kernel_object->__( 'Recommend barcode logo height 256px.' );
			$language['You can select the default order status for VitePOS orders. By default order status will be completed.']                                  = $kernel_object->__( 'You can select the default order status for VitePOS orders. By default order status will be completed.' );
		...
		public static function get_pos_languages( &$kernel_object ) {
			...
			$language['Successfully updated']                               = $kernel_object->__( 'Successfully updated' );
			$language['Successfully created']                                  = $kernel_object->__( 'Successfully created' );
			$language['Click to set custom price']                                  = $kernel_object->__( 'Click to set custom price' );
			$language['Show Outlet']                                  = $kernel_object->__( 'Show Outlet' );
			$language['Click to change sound settings']                                  = $kernel_object->__( 'Click to change sound settings' );
			$language['Show Outlet']                                  = $kernel_object->__( 'Show Outlet' );
			$language['Withdraw Note']                                  = $kernel_object->__( 'Withdraw Note' );
			$language['Coupon Can not applied on offline mode']                                  = $kernel_object->__( 'Coupon Can not applied on offline mode' );
			$language['Please add items to add coupons']                                  = $kernel_object->__( 'Please add items to add coupons' );
			$language['Enter/scan coupon code']                                  = $kernel_object->__( 'Enter/scan coupon code' );
			$language['Apply']                                  = $kernel_object->__( 'Apply' );
			$language['Shown on POS.Click to hide']                                  = $kernel_object->__( 'Shown on POS.Click to hide' );
			$language['On POS']                                  = $kernel_object->__( 'On POS' );
			$language['Hide on POS.Click to show']                                  = $kernel_object->__( 'Hide on POS.Click to show' );
			$language['Opening Date']                                  = $kernel_object->__( 'Opening Date' );
			$language['Date Between']                                  = $kernel_object->__( 'Date Between' );
			$language['Closed']                                  = $kernel_object->__( 'Closed' );
			...
			$language['Open']                                  = $kernel_object->__( 'Open' );
			$language['Max']                                  = $kernel_object->__( 'Max' );
			$language['Min']                                  = $kernel_object->__( 'Min' );
			...
			$language['Choose category']                                  = $kernel_object->__( 'Choose category' );
			$language['Choose favorite type']                                  = $kernel_object->__( 'Choose favorite type' );
			$language['Select Status']                                  = $kernel_object->__( 'Select Status' );
			$language['Publish']                                  = $kernel_object->__( 'Publish' );
			$language['Product ID']                                  = $kernel_object->__( 'Product ID' );
			...
			$language['Tax-total :']                                  = $kernel_object->__( 'Tax-total :' );
			$language['Total Fee :']                                  = $kernel_object->__( 'Total Fee :' );
			$language['Refunded-total :']                                  = $kernel_object->__( 'Refunded-total :' );
			$language['Vite Coupon Pro is Needed']                                  = $kernel_object->__( 'Vite Coupon Pro is Needed' );
			$language['For using coupon please install Vite Coupon Pro.']                                  = $kernel_object->__( 'For using coupon please install Vite Coupon Pro.' );
			$language['Get Now']                                  = $kernel_object->__( 'Get Now' );
			$language['Card number']                                  = $kernel_object->__( 'Card number' );
			$language['Are you sure to hide this product on POS']                                  = $kernel_object->__( 'Are you sure to hide this product on POS' );
			$language['Are you sure to show this product on POS']                                  = $kernel_object->__( 'Are you sure to show this product on POS' );
			$language['Outlet Stock']                                  = $kernel_object->__( 'Outlet Stock' );
			$language['available on these outlets']                                  = $kernel_object->__( 'available on these outlets' );
			$language['All outlet product stocks']                                  = $kernel_object->__( 'All outlet product stocks' );
			$language['Total stocks']                                  = $kernel_object->__( 'Total stocks' );
			$language['Are you sure to change status to active']                                  = $kernel_object->__( 'Are you sure to change status to active' );
			$language['Are you sure to change status to inactive']                                  = $kernel_object->__( 'Are you sure to change status to inactive' );
			$language['Are you sure to completing this order?']                                  = $kernel_object->__( 'Are you sure to completing this order?' );
			$language['Order has been completed']                                  = $kernel_object->__( 'Order has been completed' );
			$language['Order stated cooking']                                  = $kernel_object->__( 'Order stated cooking' );
			$language['Continue with previous drawer']                                  = $kernel_object->__( 'Continue with previous drawer' );

			
			$language['Tax Included']                                  = $kernel_object->__( 'Tax Included' );
			$language['Order preparing in kitchen']                                  = $kernel_object->__( 'Order preparing in kitchen' );
			$language['Order is ready to serve']                                  = $kernel_object->__( 'Order is ready to serve' );
			$language['Order has been served']                                  = $kernel_object->__( 'Order has been served' );
			$language['Item has been served']                                  = $kernel_object->__( 'Item has been served' );
			$language['No Waiter']                                  = $kernel_object->__( 'No Waiter' );
