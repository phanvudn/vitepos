 ...
 */
require_once __DIR__ . '/../../appsbd/v1/core/class-kernel.php';
...
class VitePos extends Kernel {
	...
	public function initialize() {
		...
		$this->skip_cache();
        add_action('admin_init',array($this,"dci_init"));
	}
	...
	public function on_init() {
		...
		if ( appsbd_is_activated_plugin( 'woocommerce/woocommerce.php' ) ) {
			...
			add_action(
				...
				function () {
					...
					/**
					 * Its for initial 3rd party api.
					 *
					 * @since 3.1.0
					 */
					do_action( 'vitepos/action/api-init', $namespace, $this );
				}
			);
     ...
     public function dci_init() {
	     if(function_exists("vtp_dci_dynamic_init")){

		     vtp_dci_dynamic_init( array(
			     'sdk_version'          => '1.2.1',
			     'product_id'           => 2,
			     'plugin_name'          => 'vitepos', 
			     ...
			     'slug'                 => 'vitepos', 
			     'core_file'            => false,
			     'plugin_deactivate_id' => 'vitepos-pro',
			     'menu'                 => array(
				     'slug' => 'vitepos',
			     ),
			     'public_key'           => 'pk_8s0g2ozfeAc7hFi8VZnL2mqYZXIBaTu3',
			     'key_prefix'           => 'vitepos',
			     'is_premium'           => false,
			     ...
			     'custom_data' => array(
				     ...
				     'pos_version' => $this->plugin_version,
			     ),
			     'popup_notice'         => false,
			     ...
			     'text_domain'          => 'vitepos',
			     'plugin_msg'           => __( 'Please help us by contributing anonymous usage data to improve our product, without collecting any sensitive information.',
				     'vitepos' ),
		     ) );
	     }
     }
	...
	public function register_modules() {
		...
		$this->add_module( 'VitePos\Modules\Appsbd_Related_App' );
	}
