...
class Mapbd_Pos_Cash_Drawer_Log extends ViteposModel {
	 ...
	 * @return bool
	 */
	public static function AddLog( $cash_drawer_id, $note, $pre_balance, $amount, $log_type, $ref_type, $ref_id,$user_note='',$extra_param='' ) {
		$newobj = new self();
	...
	public static function create_db_table() {
		...
		if ( $this_obj->db->get_var( "show tables like '{$table}'" ) != $table ) {
			$sql = "CREATE TABLE `{$table}` (
					  ...
					  `user_note` varchar(255) NULL DEFAULT '',
                      `extra_param` varchar(225) NULL DEFAULT '',
