...
class Pos_Customer_Api extends API_Base {
	...
	public function routes() {
		...
		$this->register_rest_route( 'GET', 'customer-form', array( $this, 'customer_form' ) );
	...
	public function customer_form() {
		...
		$this->response->set_response( false, '', $data );
	...
	public function create_customer() {
		if ( ! empty( $this->payload ) ) {
			...
			if ( $customer_obj->set_from_array( $this->payload, true ) ) {
				...
				$id = $customer_obj->save();
				if ( ! empty( $id ) ) {
					$rcustomer_obj = POS_Settings::get_customer_object_by_id( $id );
